...
> Можно использовать инструмент `Autopen` чтобы звук прыгал с левого уха в правую и наоборот (также можно выбрать частоту)
...
> классный прием с reverb - [](https://youtu.be/0GyYwpVfmds?t=3207)

> для реберберации вокала, лучше использовать плагинчики Valhalla
